...
def get(bot, update):
 ...
 if(username not in username_list):
    update.message.reply_text("ACCESS IMEKUWA DENIED.")
    return 
...
if __name__ == '__main__':
 main()
  ...
  #For any values in the midddle of a statement we terate the intial normal value with the current main warning procedures
   #occuring values will  be assumed to be the initiall values
    #the args given by a user are assumed to be commads which will be executed at the press of the enter,OK or anyrelated key 
     #This bot saves files entered by a user ie user detals such as usernames and many more
      #This bot was created to respond to various sets of languages including the famous kenyan and Tanzania national language "swahili" AND also English etc
